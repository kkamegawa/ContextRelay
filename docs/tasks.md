...
- Design record: [docs/adr.md](adr.md) — 2026-09-19 entry "Define the panel welcome text once, and add a Japanese README". Documentation set: [docs/plan.md](plan.md) Appendix C.
