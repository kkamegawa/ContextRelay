type DisplaySource = 'sharepoint' | 'onedrive' | 'mail' | 'teams' | 'onenote' | 'planner' | 'connectors' | 'all';

const SOURCE_TEXT_ICONS: Record<DisplaySource, string> = {
  mail: '📧',
  teams: '💬',
  sharepoint: '📄',
  onedrive: '☁️',
...
const SOURCE_LABELS: Record<DisplaySource, string> = {
  mail: 'Exchange Mail',
  teams: 'Teams',
...
const SOURCE_INLINE_SVGS: Partial<Record<DisplaySource, string>> = {
  onenote: `
